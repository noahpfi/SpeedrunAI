package com.swirb.pvpbots.oldStuff;
...
// this is an older Controller that would still work
// i just put it here as a kind of example

public class Controller {

    private final Client client;
    private final PvPBots plugin;
    ...
    public Controller(Client client) {
        this.client = client;
        this.plugin = PvPBots.getInstance();
    ...
    private void killEverything() {
        ...
        if (this.client.isInWall()) {
            ...
            for (BlockPos pos : this.client.around(false)) {
        ...
        Entity entity = this.client.nearest(100, 100, 100, entity1 -> entity1 instanceof ArmorStand);
        if ((this.client.tickCount() - this.client.getLastHurtByMobTimestamp()) < 500 && this.client.getLastHurtByMob() != null && this.client.getLastHurtByMob().getHealth() > 0 && (!(this.client.getLastHurtByMob() instanceof Client) || !this.ignoreClients)) {
                ...
                if (this.client.distanceTo(new BlockPos(entity.position()), false, true) > (5 * 5) && !this.client.isInWater() && !this.client.isInLava() && this.client.inventoryUtils.shootingWeapon() != null) {
                    ...
                    if ((shootingWeapon.getItem() instanceof BowItem && this.client.inventoryUtils.get(item -> item instanceof ArrowItem) != null) || (shootingWeapon.getItem() instanceof CrossbowItem && this.client.inventoryUtils.get(item -> item instanceof ArrowItem || item instanceof FireworkRocketItem) != null) || shootingWeapon.getItem() instanceof TridentItem) {
                        ...
                        if (this.keepChargingWeapon <= 0) {
                            ...
                            double[] angles = MathUtils.shootingAngle(this.client.position(), this.client.getDeltaMovement(), entity.position(), entity.getDeltaMovement(), velocity, false);
    ...
    public void centerBridge(Entity entity) {
        double x0 = this.client.getX();
        double z0 = this.client.getZ();
        double x1 = Mth.floor(x0) + 0.5D;
        double z1 = Mth.floor(z0) + 0.5D;
